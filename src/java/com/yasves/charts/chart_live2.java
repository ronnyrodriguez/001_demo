...
@ManagedBean
public class chart_live2 implements Serializable {
    ...
    private void createOhlcModel2(){
        ...
        ohlcModel2.setTitle(" RIO PUYO - SECTOR 001 ");
        ohlcModel2.setCandleStick(true);
        ohlcModel2.getAxis(AxisType.X).setLabel("Sector 001");
        ohlcModel2.getAxis(AxisType.Y).setLabel("Nivel de Agua");
    }
